...
GM_configStruct.prototype = {
  ...
  open: function () {
    ...
    if (this.frame) {
      this.frame.id = "GM_config"; // Allows for prefixing styles with the config id
      ...
      this.frame.addEventListener(
        ...
        function (e) {
          ...
          body.id = "GM_config"; // Allows for prefixing styles with the config id
          buildConfigWin(
            body,
  ...
  get: function (name, getLive) {
    ...
    return fieldVal != null ? fieldVal : field != null ? field.value : null;
  },
